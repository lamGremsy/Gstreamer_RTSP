...
static GstElement *queue_640, *cairo_overlay_640, *videoconvert_640, *videoscale_640, *filter_640, *videomixer_640, *x264enc_640, *appsink_640;
static GstElement *queue_320, *cairo_overlay_320, *videoconvert_320, *videoscale_320, *filter_320, *videomixer_320, *x264enc_320, *appsink_320;

static GstElement *queue_640_mix, *cairo_overlay_640_mix, *videoconvert_640_mix, *videoscale_640_mix, *filter_640_mix;
static GstElement *queue_320_mix, *cairo_overlay_320_mix, *videoconvert_320_mix, *videoscale_320_mix, *filter_320_mix;
...
static GstElement *videoconvert_640_c, *videoconvert_320_c, *videoconvert_640_c_mix, *videoconvert_320_c_mix;
...
check_IP(){
    ...
    if (strlen(check)<15)return (char*)"NULL";
    for (stt=0; stt<strlen(check);stt++){
        if (check[stt]==(char)*" "){
            memcpy(result, check, stt+1);
            return result;
        }
    }
    return (char*)"NULL";;
...
prepare_overlay (GstElement * overlay, GstCaps * caps, gpointer user_data)
{
    ...
    if(mode_stream == 0 && state->is_mix==true)
        state->valid = FALSE;
            ...
            guint64 duration, gpointer user_data)
{
    ...
    sprintf(text, "Mode: %d",s->mode_t);
    cairo_translate(cr, 0, 0);
    cairo_move_to (cr, 10, 410);
...
media_configure (GstRTSPMediaFactory * factory, GstRTSPMedia * media, gpointer user_data)
{
    ...
    videoconvert_640_c_mix  = gst_element_factory_make("videoconvert", NULL);
    cairo_overlay_640_mix   = gst_element_factory_make("cairooverlay", NULL);
    ...
    overlay_state = g_new0 (CairoOverlayState, 1);
    overlay_state->resolution = (char*)"640x480";
    overlay_state->is_mix     = true;

    g_signal_connect (cairo_overlay_640_mix, "draw", G_CALLBACK (draw_overlay), overlay_state);
    g_signal_connect (cairo_overlay_640_mix, "caps-changed", G_CALLBACK (prepare_overlay), overlay_state);

    gst_bin_add_many (GST_BIN (pipeline),
                      queue_640, videoconvert_640_c, cairo_overlay_640, videoconvert_640, videoscale_640, filter_640, videomixer_640, x264enc_640, appsink_640,
                      queue_640_mix, videoconvert_640_c_mix, cairo_overlay_640_mix, videoconvert_640_mix, videoscale_640_mix, filter_640_mix, NULL);
    gst_element_link_many(tee1, queue_640, videoconvert_640_c, cairo_overlay_640, videoconvert_640, videoscale_640, filter_640, videomixer_640, x264enc_640, appsink_640, NULL);
    gst_element_link_many(tee2, queue_640_mix, videoconvert_640_c_mix, cairo_overlay_640_mix, videoconvert_640_mix, videoscale_640_mix, filter_640_mix, videomixer_640, NULL);
...
media_configure1 (GstRTSPMediaFactory * factory, GstRTSPMedia * media, gpointer user_data)
{
    ...
    videoconvert_320_c_mix  = gst_element_factory_make("videoconvert", NULL);
    cairo_overlay_320_mix   = gst_element_factory_make("cairooverlay", NULL);
    ...
    g_signal_connect (cairo_overlay_320_mix, "draw", G_CALLBACK (draw_overlay), overlay_state);
    g_signal_connect (cairo_overlay_320_mix, "caps-changed", G_CALLBACK (prepare_overlay), overlay_state); 

    gst_bin_add_many (GST_BIN (pipeline),
                      queue_320, videoconvert_320_c, cairo_overlay_320, videoconvert_320, videoscale_320, filter_320, videomixer_320, x264enc_320, appsink_320,
                      queue_320_mix, videoconvert_320_c_mix, cairo_overlay_320_mix, videoconvert_320_mix, videoscale_320_mix, filter_320_mix, NULL);
    gst_element_link_many(tee1, queue_320, videoconvert_320_c, cairo_overlay_320, videoconvert_320, videoscale_320, filter_320, videomixer_320, x264enc_320, appsink_320, NULL);
    gst_element_link_many(tee2, queue_320_mix, videoconvert_320_c_mix, cairo_overlay_320_mix, videoconvert_320_mix, videoscale_320_mix, filter_320_mix, videomixer_320, NULL);
...
handle_keyboard (GIOChannel * source, GIOCondition cond, gpointer data)
{
    ...
    switch (g_ascii_tolower (str[0])) {
        ...
        case 'm':
            mode_stream++;
            if (mode_stream==3)mode_stream=0;
